...
#used ai for the class, the one i wrote didn't work and needed help on how to make it work: Joseph's Code
...
#100% ai i could not figure out on how to make the csv file to print the countries into different columns while going down in rows
import csv
import os
